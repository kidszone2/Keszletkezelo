...
namespace RF.Modules.TestFlightAppointment.Controllers
{
    ...
    public class SettingsController : DnnController
    {
        ...
        {
            ModuleContext.Configuration.ModuleSettings["RF.Modules.TestFlightAppointment_Setting1"] = settings.Setting1.ToString();
            ModuleContext.Configuration.ModuleSettings["RF.Modules.TestFlightAppointment_Setting2"] = settings.Setting2.ToUniversalTime().ToString("u");
